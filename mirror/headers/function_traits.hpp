...
namespace mirror 
{
	...
	struct function_traits<return_type(args_types...)>
	{
		using void_signature = void*;
	...
	template <typename return_type, typename... args_types>
	struct function_traits<return_type(args_types...) noexcept>
	{
		using void_signature = void*;
	...
	struct function_traits<return_type(instance_type::*)(args_types...)>
	{
	...
	template <typename instance_type, typename return_type, typename... args_types>
	struct function_traits<return_type(instance_type::*)(args_types...) noexcept>
	{
		using void_signature = void(instance_type::*)(void);
	...
	template <typename instance_type, typename return_type, typename... args_types>
	struct function_traits<return_type(instance_type::*)(args_types...) const>
	{
		using void_signature = void(instance_type::*)(void);
	...
	template <typename instance_type, typename return_type, typename... args_types>
	struct function_traits<return_type(instance_type::*)(args_types...) const noexcept>
	{
		using void_signature = void(instance_type::*)(void);
